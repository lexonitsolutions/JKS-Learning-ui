...
// Adapted from "Threads" — react-bits (https://reactbits.dev/backgrounds/threads),
// © David Haz, MIT + Commons Clause license. Used here as part of the JKS
// Learning product UI (permitted use); not redistributed as a standalone
// component library. Colors/perf integration adapted for this project.
...
export default function ThreadsScene({
  ...
  // Keep the ref in sync with the latest props for the rAF loop's closure
  // below to read — writing to a ref must happen in an effect, not during
  // render (react-hooks/refs). Runs after every render, no deps needed.
  useEffect(() => {
