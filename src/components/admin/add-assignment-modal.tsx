  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 dark:bg-black/75 p-4 backdrop-blur-xs">
      <motion.div
        ...
        className="relative flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-[24px] border border-white/70 bg-white/90 shadow-2xl backdrop-blur-xl dark:border-slate-800 dark:bg-surface-secondary dark:shadow-none"
      >
        {/* Header */}
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-900 outline-none focus:border-[#2563EB] focus:ring-2 focus:ring-[#2563EB]/15 dark:border-slate-700/80 dark:bg-input-bg dark:text-white dark:placeholder-slate-400 dark:focus:border-blue-500"
              />
            </div>
            ...
            <div className="flex items-center justify-between rounded-xl bg-slate-50 dark:bg-surface-elevated p-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-16 rounded-md border border-slate-200 bg-white px-2 py-1 text-center text-xs font-bold text-slate-900 dark:border-slate-700/80 dark:bg-input-bg dark:text-white"
                />
