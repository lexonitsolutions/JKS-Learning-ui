...
export function AboutFinalCta() {
  return (
    <section className="relative bg-bg-light dark:bg-[#0B1020] text-text-heading dark:text-white py-24 lg:py-36 px-6 lg:px-16 border-t border-border dark:border-slate-800/80 overflow-hidden transition-colors duration-300">
      <div className="mx-auto max-w-4xl text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          ...
          <Link
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-300 dark:border-slate-700/80 bg-white dark:bg-[#111827] px-8 py-4 text-sm font-bold text-slate-800 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-[#151D2E] transition-all cursor-pointer"
          >
