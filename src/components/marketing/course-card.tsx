  ...
  return (
    <TiltCard className="h-full">
      <Link href={`/courses/${course.slug}`} className="block h-full">
        <Card className="h-full flex flex-col justify-between transition-shadow hover:shadow-lg rounded-2xl overflow-hidden border border-slate-200/80 bg-white">
          <div>
            ...
            <div className="p-3 sm:p-5">
              ...
              <div className="mt-2.5 sm:mt-4 flex flex-wrap items-center gap-2 sm:gap-4 text-[10px] sm:text-body-sm text-text-body">
                <span className="flex items-center gap-0.5 sm:gap-1">
                  <Clock className="h-3 w-3 sm:h-4 sm:w-4 text-slate-400" /> {course.durationWeeks}w
                </span>
                <span className="flex items-center gap-0.5 sm:gap-1">
                  <Users className="h-3 w-3 sm:h-4 sm:w-4 text-slate-400" /> {course.studentsEnrolled.toLocaleString()}
                </span>
                <span className="flex items-center gap-0.5 sm:gap-1 font-bold text-slate-700">
          ...
          <div className="p-3 sm:p-5 pt-0">
            <div className="flex items-center justify-between border-t border-border pt-2.5 sm:pt-4">
