      ...
      <div className="relative mx-auto max-w-[1360px] px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col items-start z-10">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-blue-200 dark:border-blue-800/80 bg-blue-50/80 dark:bg-blue-950/60 px-3.5 py-1.5 backdrop-blur-sm"
            >
              <Sparkles className="h-3.5 w-3.5 text-primary-blue dark:text-blue-400" />
              <span className="text-[11px] font-bold tracking-wider text-primary-blue dark:text-blue-400 uppercase">
            ...
            <motion.h1
              ...
              className="mt-6 text-4xl sm:text-5xl lg:text-[56px] font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.1]"
            >
            ...
            <motion.p
              ...
              className="mt-6 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed max-w-lg"
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="leading-tight">
                      <div className="text-[11px] font-bold text-slate-800 dark:text-white">{pill.title}</div>
                      <div className="text-[10px] text-slate-500 dark:text-slate-400">{pill.sub}</div>
                    </div>
                  </div>
                );
              })}
          ...
          >
            ...
            >
              ...
              <div
                className="pointer-events-none absolute left-1/2 top-1/2 h-[75%] w-[85%] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-70 dark:opacity-40"
                style={{
                  background:
              ...
              {!reducedMotion &&
                [
                  ...
                  <motion.span
                    key={i}
                    className="pointer-events-none absolute rounded-full bg-primary-blue/20 dark:bg-primary-blue/40"
            ...
            >
              ...
              <div className="mt-2.5 flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 font-mono">
                <span>02:45</span>
                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-950/60 text-primary-blue dark:text-blue-400">
            ...
            >
              ...
              <div className="mt-3 flex items-center gap-4">
                ...
                <div className="relative flex h-16 w-16 shrink-0 items-center justify-center">
                  ...
                  <span className="absolute text-sm font-extrabold text-slate-900 dark:text-white">92%</span>
                </div>
            ...
            >
              ...
              <div className="mt-3 relative h-16 w-full flex items-end">
                <svg className="h-full w-full overflow-visible" viewBox="0 0 160 50">
                  {/* Grid Lines */}
                  <line x1="0" y1="45" x2="160" y2="45" className="stroke-slate-200 dark:stroke-slate-800" strokeWidth="1" />
                  <line x1="0" y1="25" x2="160" y2="25" className="stroke-slate-200 dark:stroke-slate-800" strokeWidth="1" />
                ...
                {/* Goal Flag Pin */}
                <div className="absolute right-0 top-0 flex h-5 w-5 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-950/60 text-primary-blue dark:text-blue-400">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-7 sm:gap-10 text-slate-700 dark:text-slate-300 font-bold opacity-80">
              ...
              <span className="text-sm tracking-tight font-sans font-bold text-blue-600 dark:text-blue-400">
                Infosys
              </span>
