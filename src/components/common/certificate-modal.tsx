  ...
  const modalContent = (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl rounded-2xl sm:rounded-3xl border border-slate-700/60 bg-slate-900 shadow-2xl overflow-hidden print:border-none print:shadow-none print:max-w-full my-auto print:my-0">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800 bg-slate-950 px-5 py-3 text-white print:hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-emerald-600 px-3.5 py-1.5 text-xs font-bold text-white hover:bg-emerald-700 active:scale-95 transition-all shadow-md cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={handlePrint}
              className="flex items-center gap-1.5 rounded-xl bg-[#2563EB] px-3.5 py-1.5 text-xs font-bold text-white hover:bg-blue-600 active:scale-95 transition-all shadow-md cursor-pointer"
            >
        ...
        <div
          ref={printRef}
          className="certificate-printable-sheet relative p-5 sm:p-7 md:p-8 text-slate-900 bg-gradient-to-br from-[#FAFCFF] via-[#F3F7FD] to-[#EAF1FC] overflow-hidden select-none"
        >
          {/* Double Gold & Royal Blue Border */}
          <div className="pointer-events-none absolute inset-3 sm:inset-4 rounded-2xl border-4 border-[#1E40AF]/90" />
          <div className="pointer-events-none absolute inset-4 sm:inset-5 rounded-xl border border-amber-500/60" />

          {/* Corner Flourishes */}
          <div className="pointer-events-none absolute top-6 left-6 h-7 w-7 border-t-2 border-l-2 border-amber-500" />
          <div className="pointer-events-none absolute top-6 right-6 h-7 w-7 border-t-2 border-r-2 border-amber-500" />
          <div className="pointer-events-none absolute bottom-6 left-6 h-7 w-7 border-b-2 border-l-2 border-amber-500" />
          <div className="pointer-events-none absolute bottom-6 right-6 h-7 w-7 border-b-2 border-r-2 border-amber-500" />
          ...
          <div className="relative z-10 flex flex-col items-center text-center space-y-2.5 sm:space-y-3 px-3 sm:px-6 py-1">
            {/* Header / Logo */}
            <div className="flex items-center justify-center pt-0.5">
              <img
                src="/images/jks-logo.png"
                alt="JKS Learning Technologies Institute"
                className="h-9 sm:h-11 w-auto max-w-[220px] sm:max-w-[260px] object-contain select-none"
            ...
            <div className="space-y-0.5">
              ...
              <h1 className="text-xl sm:text-2xl md:text-3xl font-black text-slate-950 tracking-tight font-serif">
                Certificate of Course Mastery
              </h1>
              <div className="h-0.5 w-24 sm:w-32 bg-gradient-to-r from-transparent via-amber-500 to-transparent mx-auto mt-1" />
            </div>
            ...
            <div className="space-y-0.5">
              <div className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1E3A8A] font-serif tracking-wide underline decoration-amber-400 decoration-2 underline-offset-6">
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50/80 px-5 py-1.5 shadow-xs">
            ...
            <div className="w-full pt-3 sm:pt-4 border-t border-slate-300 grid grid-cols-3 items-end text-xs">
