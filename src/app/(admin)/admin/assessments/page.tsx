      ...
      <div className="flex-1 space-y-5 p-3 sm:p-6 lg:p-8 lg:pt-4">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2.5">
          <Link
            ...
            className="flex items-center justify-center gap-1.5 rounded-xl border border-blue-200 bg-blue-50 px-3.5 py-2 sm:px-4 sm:py-2.5 text-xs font-bold text-[#2563EB] hover:bg-blue-100 dark:border-blue-800/60 dark:bg-blue-950/40 dark:text-blue-400 dark:hover:bg-blue-900/50 transition-all cursor-pointer"
          >
