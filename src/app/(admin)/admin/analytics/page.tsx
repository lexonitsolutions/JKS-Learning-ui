      ...
      <div className="flex-1 space-y-6 p-4 pt-3 sm:p-6 lg:p-8 lg:pt-4">
        ...
        <Reveal variant="stagger" className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
          ...
          <div className="rounded-[20px] border border-white/70 bg-white/75 p-3.5 sm:p-5 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#111827] dark:shadow-none">
            ...
            <div className="mt-2 text-lg sm:text-2xl font-extrabold text-slate-900 dark:text-white leading-tight">₹1.24 Cr</div>
            <div className="mt-1 text-[10px] sm:text-xs text-emerald-600 dark:text-emerald-400 font-semibold truncate">+14.2% YoY growth</div>
          </div>
          </TiltCard>
          ...
          <div className="rounded-[20px] border border-white/70 bg-white/75 p-3.5 sm:p-5 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#111827] dark:shadow-none">
            ...
            <div className="mt-2 text-lg sm:text-2xl font-extrabold text-slate-900 dark:text-white leading-tight">89.4%</div>
            <div className="mt-1 text-[10px] sm:text-xs text-emerald-600 dark:text-emerald-400 font-semibold truncate">Anti-skip enforced</div>
          </div>
          </TiltCard>
          ...
          <div className="rounded-[20px] border border-white/70 bg-white/75 p-3.5 sm:p-5 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#111827] dark:shadow-none">
            ...
            <div className="mt-2 text-lg sm:text-2xl font-extrabold text-slate-900 dark:text-white leading-tight">8,140</div>
            <div className="mt-1 text-[10px] sm:text-xs text-purple-600 dark:text-purple-400 font-semibold truncate">High engagement</div>
          </div>
          </TiltCard>
          ...
          <div className="rounded-[20px] border border-white/70 bg-white/75 p-3.5 sm:p-5 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#111827] dark:shadow-none">
            ...
            <div className="mt-2 text-lg sm:text-2xl font-extrabold text-slate-900 dark:text-white leading-tight">22,000+</div>
            <div className="mt-1 text-[10px] sm:text-xs text-amber-600 dark:text-amber-400 font-semibold truncate">Sessions done</div>
          </div>
          </TiltCard>
        </Reveal>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          <div className="rounded-[20px] border border-white/70 bg-white/80 p-4 sm:p-6 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#111827] dark:shadow-none lg:col-span-7">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">30-day continuous revenue stream</p>
              </div>
              <div className="text-sm font-extrabold text-[#2563EB] dark:text-blue-400">₹12.4L MTD</div>
            </div>
          ...
          <div className="flex flex-col justify-between rounded-[20px] border border-white/70 bg-white/80 p-4 sm:p-6 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#111827] dark:shadow-none lg:col-span-5">
            ...
            <div className="mt-6 rounded-2xl bg-gradient-to-r from-[#EFF6FF] to-blue-50/60 p-4 text-xs text-slate-700 border border-blue-100/80 dark:from-blue-950/30 dark:to-slate-900/40 dark:border-blue-900/40 dark:text-slate-300">
              <div className="font-bold text-[#2563EB] dark:text-blue-400">Executive Growth Summary</div>
