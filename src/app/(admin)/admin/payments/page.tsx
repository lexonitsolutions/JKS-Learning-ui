        ...
        <Reveal variant="stagger" className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <TiltCard>
            <div className="rounded-[20px] border border-white/70 bg-white/75 p-4 sm:p-5 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-surface-secondary dark:shadow-none">
              ...
              <div className="mt-2 text-2xl font-extrabold text-slate-900 dark:text-white">UPI / Cards / EMI</div>
              <div className="mt-1 text-xs text-slate-500 dark:text-slate-400 font-medium">Instant automated invoice numbering</div>
            </div>
          </TiltCard>
        </Reveal>
                  ...
                  <tr key={inv.id} className="transition-colors hover:bg-slate-50/60 dark:hover:bg-surface-hover">
                    ...
                    <td className="pr-0 py-4 pl-4 text-right whitespace-nowrap">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-xl bg-blue-50 border border-blue-200 px-3 py-1.5 text-xs font-bold text-[#2563EB] hover:bg-blue-100 dark:bg-blue-950/40 dark:border-blue-800/60 dark:text-blue-400 dark:hover:bg-blue-900/50 transition-colors cursor-pointer"
                      >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-xs dark:bg-black/75">
          <div className="relative w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl space-y-4 dark:border-slate-800 dark:bg-surface-secondary">
            ...
            <form onSubmit={handleCreate} className="space-y-3 text-xs">
              ...
              <div>
                <label className="font-bold text-slate-700 dark:text-slate-300">Course Track</label>
                <select
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="font-bold text-slate-700 dark:text-slate-300">Standard Fee (₹)</label>
                  <input
                    type="number"
                    value={form.price}
                ...
                <div>
                  <label className="font-bold text-slate-700 dark:text-slate-300">Discount / Scholarship (₹)</label>
                  <input
                    type="number"
                    value={form.discount}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="font-bold text-slate-700 dark:text-slate-300">Batch Timing</label>
                  <select
              ...
              <div className="rounded-xl border border-blue-100 bg-blue-50/70 p-3 text-[11px] text-blue-900 dark:border-blue-900/40 dark:bg-blue-950/30 dark:text-blue-300 space-y-0.5">
