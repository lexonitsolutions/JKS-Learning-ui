          ...
          {kpiCards.map((card) => {
            ...
            return (
              <TiltCard key={card.label}>
                <div className="group relative flex h-full flex-col justify-between rounded-[20px] border border-white/70 bg-white/75 p-3.5 sm:p-5 lg:p-6 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_35px_rgba(20,50,100,0.1)]">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Live settled revenue from database invoices</p>
                </div>
              ...
              <div className="mt-3 flex items-baseline gap-2.5">
                ...
                <span className="text-xs font-bold text-[#16A34A]">
                  Settled Volume <span className="font-normal text-slate-500">across {invoices.length} transactions</span>
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Live enrolled student records and milestones</p>
                </div>
                <Link
                  href="/admin/students"
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3.5 whitespace-nowrap">
                              <div className="font-medium text-slate-800 max-w-[180px] truncate">{row.courseTitle}</div>
                              <span className="inline-block mt-0.5 rounded bg-blue-50 px-1.5 py-0.5 text-[9px] font-semibold text-blue-600">
                                {row.track}
                              </span>
                            </td>
                            <td className="px-4 py-3.5 text-center whitespace-nowrap">
                              <div className="inline-flex items-center gap-1">
                                ...
                                <span className="text-xs font-black text-slate-800">{ratingScore}</span>
                                <span className="text-[10px] text-slate-400 font-medium">/5</span>
                              </div>
                            </td>
                            <td className="pr-0 py-3.5 pl-4 text-right text-[11px] font-medium text-slate-500 whitespace-nowrap">
                              {row.batchTiming}
                            </td>
                          </tr>
                        );
