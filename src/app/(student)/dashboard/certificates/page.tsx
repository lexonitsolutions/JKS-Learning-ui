              ...
              {earnedCertificates.map((cert) => (
                ...
                >
                  <div>
                    ...
                    <div className="mt-4 font-mono text-xs font-bold text-[#2563EB] dark:text-blue-400 break-all">
                      ID: {cert.id}
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 border-t border-slate-100 dark:border-slate-800 pt-4">
                    <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400 flex items-center gap-1">
                      <ShieldCheck className="h-3.5 w-3.5 shrink-0" /> Blockchain Authenticated
                    </span>
                    <div className="grid grid-cols-3 sm:flex items-center gap-2 w-full sm:w-auto">
                      <Link
                        href={`/certificate/verify/${encodeURIComponent(cert.verificationId || cert.id)}`}
                        target="_blank"
                        className="flex items-center justify-center gap-1 sm:gap-1.5 rounded-xl border border-blue-200 bg-blue-50/60 py-2 px-2 sm:px-3 text-[11px] sm:text-xs font-bold text-[#2563EB] hover:bg-blue-100/60 dark:border-blue-900/40 dark:bg-blue-950/40 dark:text-blue-400 dark:hover:bg-blue-900/40 cursor-pointer transition-colors text-center"
                      ...
                      <button
                        ...
                        className="flex items-center justify-center gap-1 sm:gap-1.5 rounded-xl border border-slate-200 bg-slate-50 py-2 px-2 sm:px-3.5 text-[11px] sm:text-xs font-bold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:bg-surface-elevated dark:text-slate-200 dark:hover:bg-surface-hover cursor-pointer text-center"
                      >
                      ...
                      <button
                        type="button"
                        onClick={() => setSelectedCert(cert)}
                        className="flex items-center justify-center gap-1 sm:gap-1.5 rounded-xl bg-[#2563EB] py-2 px-2 sm:px-3.5 text-[11px] sm:text-xs font-bold text-white shadow-xs hover:bg-blue-700 cursor-pointer text-center"
                      >
