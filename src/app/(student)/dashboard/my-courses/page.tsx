        ...
        {isLoading && (
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            {[1, 2].map((n) => (
              <div
                key={n}
                className="h-80 rounded-[22px] border border-slate-200 bg-white/70 p-6 shadow-sm animate-pulse space-y-4 dark:border-slate-800 dark:bg-surface-secondary/70"
              >
              ...
              <TiltCard key={course.id || course.slug} className="h-full">
                <div className="flex h-full flex-col justify-between overflow-hidden rounded-[22px] border border-white/80 bg-white/90 shadow-[0_8px_30px_rgb(20,50,100,0.06)] backdrop-blur-xl transition-all duration-300 hover:shadow-xl hover:border-blue-200 dark:border-slate-800/80 dark:bg-surface-secondary dark:hover:border-blue-500/40">
                  ...
                  <div className="flex-1 p-6 space-y-4">
                    ...
                    <div className="rounded-xl bg-slate-50/90 p-3 border border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs dark:bg-surface-elevated dark:border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="truncate">
                          <div className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-400">Lead Faculty</div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="truncate">
                          <div className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-400">Batch Cohort</div>
                    ...
                    {/* Last Accessed Date */}
                    <div className="flex items-center gap-1.5 text-[11px] text-slate-400 dark:text-slate-400 font-medium pt-1">
