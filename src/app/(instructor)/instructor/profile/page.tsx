          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 border-b border-slate-100 dark:border-slate-800 pb-6">
            ...
            <div className="space-y-1 text-center sm:text-left">
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                ...
                <span className="rounded-full bg-emerald-50 dark:bg-emerald-950/50 px-2.5 py-0.5 text-[11px] font-bold text-emerald-700 dark:text-emerald-400">
                  Verified Faculty
                </span>
              </div>
              <p className="text-xs font-semibold text-[#2563EB] dark:text-blue-400">{title}</p>
              <p className="text-xs text-slate-400 dark:text-slate-400 font-medium">{track}</p>
            </div>
          </div>
