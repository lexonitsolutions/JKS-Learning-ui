            ...
            <div className="sticky top-28 space-y-4 rounded-2xl border border-slate-200/90 bg-white p-6 shadow-sm dark:bg-surface-secondary dark:border-slate-800/80">
              ...
              <div className="mt-6 rounded-xl bg-slate-50 p-4 border border-slate-100 dark:bg-surface-elevated dark:border-slate-800">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-slate-800 dark:text-slate-200">Have a privacy inquiry?</h3>
                    <p className="mt-1 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                      Reach our dedicated Data Protection Officer at{" "}
                      <a href="mailto:privacy@jkslearning.com" className="text-blue-600 font-semibold hover:underline dark:text-blue-400">
          ...
          <main className="space-y-12 lg:col-span-8">
            ...
            <article id="ai-data-processing" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">4. AI Mock Interview & Code Data</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="third-parties" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">5. Sub-Processors & Data Sharing</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <div className="overflow-x-auto rounded-xl border border-slate-200 bg-white dark:bg-surface-secondary dark:border-slate-800">
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100 text-slate-600 dark:divide-slate-800 dark:text-slate-400">
                    <tr>
                      <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Clerk Auth</td>
                      <td className="p-3">User Authentication & Social SSO (Google/GitHub)</td>
                      <td className="p-3">Email, Name, User ID, Session Tokens</td>
                    </tr>
                    <tr>
                      <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">MongoDB Atlas / PostgreSQL</td>
                      <td className="p-3">Secure Database Hosting</td>
                      <td className="p-3">Course enrollments, milestone progress, scores</td>
                    </tr>
                    <tr>
                      <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Cloudflare</td>
                      <td className="p-3">DDoS Protection, WAF & Bot Verification</td>
                      <td className="p-3">IP Address, Request Telemetry</td>
                    </tr>
                    <tr>
                      <td className="p-3 font-semibold text-slate-800 dark:text-slate-200">Razorpay / Stripe</td>
            ...
            <article id="cookies-storage" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">6. Cookies & Tracking Technologies</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="data-security" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">7. Data Protection & Security</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="your-rights" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">8. Your Legal Rights & Data Choices</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="international-transfers" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">9. International Transfers & DPDP Compliance</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="policy-updates" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">10. Policy Updates & Contact Information</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
