        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
            ...
            <div className="sticky top-28 space-y-4 rounded-2xl border border-slate-200/90 bg-white p-6 shadow-sm dark:bg-[#111827] dark:border-slate-800/80">
              ...
              <div className="mt-6 rounded-xl bg-slate-50 p-4 border border-slate-100 dark:bg-[#151D2E] dark:border-slate-800">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-slate-800 dark:text-slate-200">Need legal assistance?</h3>
                    <p className="mt-1 text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
                      Contact our legal counsel team at{" "}
                      <a href="mailto:legal@jkslearning.com" className="text-blue-600 font-semibold hover:underline dark:text-blue-400">
          ...
          <main className="space-y-12 lg:col-span-8">
            ...
            <div className="rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50 via-indigo-50/40 to-white p-6 shadow-sm dark:bg-gradient-to-r dark:from-blue-950/30 dark:via-indigo-950/20 dark:to-[#111827] dark:border-blue-900/40">
              ...
              <ul className="mt-3 space-y-2 text-xs text-slate-700 dark:text-slate-300 leading-relaxed">
            ...
            <article id="acceptance" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-100 text-blue-700 dark:bg-blue-950/60 dark:text-blue-400">
                  <Scale className="h-4 w-4" />
                </div>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">1. Acceptance of Terms & Eligibility</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
                ...
                <strong className="text-slate-800 font-semibold dark:text-slate-200">https://jks-learning-ui.vercel.app</strong>, you confirm that you are at least 18 years of age (or have explicit parental/guardian consent) and possess legal capacity to enter into this contract.
              </p>
            </article>
            ...
            <article id="accounts" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">2. User Accounts, Credentials & Security</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-4 dark:bg-amber-950/20 dark:border-amber-900/40">
            ...
            <article id="enrollment-fees" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">3. Course Enrollment, Pricing & Payments</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <ul className="space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300 list-disc pl-5 leading-relaxed">
            ...
            <article id="refund-policy" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">4. Cancellation & 7-Day Refund Policy</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="intellectual-property" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">5. Intellectual Property & Course Materials License</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="code-of-conduct" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">6. Student Code of Conduct & Academic Integrity</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="ai-interview-rules" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">7. AI Mock Interview & Skill Simulator Usage</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="certificates" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">8. Verified Certification & Employer Verification</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="career-disclaimer" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">9. Career Placement Support & Disclaimer</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="liability-disclaimer" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">10. Limitation of Liability</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="termination" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">11. Suspension & Account Termination</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <article id="governing-law" className="scroll-mt-28 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">12. Governing Law, Jurisdiction & Contact</h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 to-slate-950 p-6 text-white shadow-lg dark:border-slate-800">
