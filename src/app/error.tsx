...
export default function RootError({
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full text-center space-y-6 bg-white dark:bg-surface-secondary border border-slate-200 dark:border-slate-800 p-8 rounded-2xl shadow-xl">
